...
function textbox(locals) {
  ...
  var controlIconStyle = stylesheet.controlIcon.normal;
  ...
  var icon = locals.icon ? <Image style={controlIconStyle} source={require(locals.icon)}></Image> : null;
  var test = locals.test;
